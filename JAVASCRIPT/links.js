...
for (var i = headers.length - 1; i >= 0; i--) {
	if (headers[i].innerText === 'Loki Docs') {
		headers[i].innerHTML = '<a href="https://www.loki.network">Home </a><a href="../..">Documentation </a><a href="https://loki.network/#team-section">Team </a><a href="https://loki.network/#papers">Papers </a> <a href="https://loki.network/blog/"">Blog</a>';
	}
}
